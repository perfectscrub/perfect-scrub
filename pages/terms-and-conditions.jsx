...
const TermsAndConditions = () => {
  return (
    <>
      <Head>
        <title>Perfect Scrub Cleaning Services - Terms and Conditions</title>
        <meta
          content="Terms and conditions for the use of our services"
          name="description"
        />
      </Head>
      ...
      <main role="main">
        ...
        <section className="pt-36 pb-40 lg:pt-40 lg:pb-32 flex justify-center">
          <article className="max-w-screen-xl lg:mx-8">
            ...
            <div className="max-w-prose mx-6 lg:mx-auto text-gray-600 mt-16 lg:mt-24">
              ...
              <p className="mb-4">
                This website www.perfectscrubcleaning.com (the “SITE”) is owned
                and operated by Perfect Scrub Cleaning Services (“COMPANY” “we”
                or “us”). By using the Site, you agree to be bound by these
                Terms of Service and to use the Site in accordance with these
                Terms of Service, our Privacy Policy and any additional terms
                and conditions that may apply to specific sections of the Site
                or to products and services available through the Site or from
                COMPANY. Accessing the Site, in any manner, whether automated or
                otherwise, constitutes use of the Site.
              </p>
        ...
        <section className="get_started__header flex flex-col items-center pt-14 pb-16 lg:pt-18 lg:pb-20 bg-blue-900">
