...
const StandardCleaning = () => {
  ...
  <section className="standard-bg-image flex">
    <div className="z-20 self-center md:self-start md:pl-16">
        ...
        <h1 className="font-semibold text-3xl lg:text-5xl text-gray-50 mb-8">Standard Cleaning</h1>
      </div>
      {/* Monogram Overlay */}
      <Image width={300} height={300} className="absolute max-w-xs z-10 opacity-30 -bottom-5 -left-10 w-3/4" src="/ps-monogram-white.svg" alt="" />
  </section>

  {/* Start Information section */}
  <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
    <article>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">Our standard commercial
        cleaning service encompasses a range of tasks to ensure a clean and sanitized environment. This includes
        dusting,
        sweeping,
        mopping, disinfecting, and sanitizing all washrooms. We also handle garbage removal and disposal, as well as
        thorough cleaning of all visible surfaces. You have the flexibility to choose the
        frequency of our cleaning service, whether it's on a daily, weekly, or monthly basis.</p>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">Additionally, we provide
        the
        option to customize your cleaning schedule to better suit your specific needs. When we begin our regular
        cleaning
        services, we offer one standard clean with a comprehensive deep clean.</p>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">Please see our deep
        cleaning
        service for more information on increasing your deep clean frequency.</p>
    </article>
    <ServicesAside />
  ...
  <section className="flex flex-col px-4 py-16 justify-center bg-white">
    <div className="flex flex-col-reverse md:flex-row justify-between">
      ...
      <div className="lg:block mb-0 lg:-mb-16 w-1/2 self-center">
        <Image width={300} height={300} className="max-h-full object-cover" src="/woman-with-spray-bottle.png"
