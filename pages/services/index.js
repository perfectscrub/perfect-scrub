...
const Services = () => {
  return (
    <>
      <Head>
        <title>
          Perfect Scrub Cleaning Services - Cleaning Services Page
        </title>
        <meta content="We have all the cleaning services you need to keep your business up and running smoothly. Call us or use our contact form" name="description" />
      </Head>
      <main role="main">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between">
            ...
            <div className="lg:block mb-0 lg:-mb-16 w-1/2 self-center">
              <Image
                width={500}
                height={526}
                className="lg:block max-h-full object-cover"
