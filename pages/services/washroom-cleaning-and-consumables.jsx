...
const WashroomCleaningAndConsumables = () => {
  ...
  <section className="washroom-bg-image flex">
    <div className="z-20 self-center md:self-start md:pl-16">
        ...
        <h1 className="font-semibold text-3xl lg:text-5xl text-gray-50 mb-8">Washroom services <br/>and Consumables</h1>
        </div>
        {/* Monogram Overlay */}
  ...
  <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
    <article>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">Maintaining a clean and
        hygienic washroom facility is crucial for any organization. At Perfect Scrub, we offer a comprehensive range of
        paper products, dispensing systems, soap, and hand wash products that cater to various budgets.</p>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">We understand the
        importance of keeping customer and staff toilets clean and well-maintained to uphold high standards. Through our
        professional cleaning service, we ensure that your washrooms are impeccably cleaned and maintained to the
        highest levels of cleanliness and hygiene. Our team conducts regular quality inspections to ensure consistent
        service excellence.</p>
      <Image width={500} height={500} className="max-h-full lg:h-100 mx-auto object-cover mb-10" src="/toilet-paper-carton.jpg"
        alt="a box of toilet paper"/>
      <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">We also ensure that your
        washrooms are well stocked with the necessary consumables, guaranteeing a seamless experience for your visitors
        and staff.</p>
    </article>
    <ServicesAside />
  ...
  <section className="flex flex-col px-4 py-16 justify-center bg-white">
    <div className="flex flex-col-reverse md:flex-row justify-between">
      ...
      <div className="lg:block mb-0 lg:-mb-16 w-1/2 self-center">
        <Image width={300} height={300} className="max-h-full object-cover" src="/woman-with-spray-bottle.png" alt="woman holding spray bottle"/>
      </div>
    </div>
