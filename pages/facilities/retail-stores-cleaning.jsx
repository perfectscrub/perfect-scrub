...
const RetailStoresCleaning = () => {
  ...
  <section className="retail-bg-image flex">
      <div className="z-20 self-center md:self-start md:pl-16">
          ...
          <h1 className="font-semibold text-3xl lg:text-5xl text-gray-50 mb-8">Retail stores and <br />Shopping centers
          </h1>
      {/* Monogram Overlay */}
      <Image width={500} height={500}  className="absolute max-w-xs z-10 opacity-30 -bottom-5 -left-10 w-3/4" src="/ps-monogram-white.svg"
          alt="" />
      </div>
  </section>
  ...
  <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
      <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">When it comes to
              maintaining a pristine and inviting atmosphere in your retail store, Perfect Scrub Cleaning is the
              ultimate choice. With constant foot traffic entering and exiting your store, it's crucial to have a
              clean environment that enhances the customer service experience. Our professional cleaning services
              allow you to focus on the business of selling while we handle the clean-up process.</p>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">Retail stores are
              particularly sensitive environments with numerous touchpoints that require regular disinfection. At
              Perfect Scrub Cleaning, we know how important it is to maintain a safe and healthy space for both
              your staff and customers. Our service ensures a thorough cleaning of all surfaces and implements regular
              disinfection using Canadian approved disinfectants. This helps to prevent the spread of germs and
              ensures the well-being of everyone in your store.</p>
          {/* <Image width={500} height={500}  className="max-h-full lg:h-100 mx-auto object-cover mb-10" src=""
              alt="" /> */}
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">For the best quote
              and to experience our exceptional cleaning services tailored specifically for retail stores, don't
              hesitate to contact us today. We are dedicated to providing you with a clean and welcoming environment
              that leaves a positive impression on your customers.
          </p>
      </article>
      <aside className="hidden lg:block">
          ...
          <ul className="pl-3 text-lg">
              ...
              <li className="py-2 pr-1 border-b hover:text-blue-600 hover:border-blue-600"><Link
                      href="school-cleaning">Schools and universities</Link>
              </li>
              <li className="py-2 pr-1 border-b hover:text-blue-600 hover:border-blue-600"><Link
                      href="medical-office-cleaning">Medical Offices and clinics</Link>
              </li>
              <li className="py-2 pr-1 border-b hover:text-blue-600 hover:border-blue-600"><Link
                      href="hotel-cleaning">Hotels and resorts</Link></li>
              <li className="py-2 pr-1 border-b hover:text-blue-600 hover:border-blue-600"><Link
  ...
  <section className="flex flex-col px-4 py-16 justify-center bg-white">
      <div className="flex flex-col-reverse md:flex-row justify-between">
          ...
          <div className="lg:block mb-0 lg:-mb-16 w-1/2 self-center">
              <Image width={500} height={500}  className="object-cover" src="/woman-with-spray-bottle.png" alt="woman holding spray bottle" />
          </div>
      </div>
