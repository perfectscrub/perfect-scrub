  ...
  return (
    <>
      <Head>
        ...
        <meta
          content="We are able to clean bowling alleys, arcades, and other recreational spots indoor and outdoor with easy and attention to detail."
          name="description"
        />
      </Head>
      <main role="main">
        {/* Start of 'Facilities' Landing */}
        <LandingSection bgImg={"recreational-bg-image"} type={"facilities"} title={"Sports & Recreational Facilities"} />
        ...
        <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
          <article>
            ...
            <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
              ...
              experience for your patrons. Our dedicated service teams are
              trained in deep cleaning techniques, ensuring that all areas,
              including high-touch surfaces, floors, and equipment, receive the
            ...
            />
            <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
              Whether it's sanitizing exercise machines and yoga mats,
              maintaining cleanliness in locker rooms and shower facilities, or
              ensuring the lanes and seating areas in a bowling alley are
              pristine, we have the expertise to handle the unique cleaning
            ...
            <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
              ...
              ensures that your venues are consistently clean, creating a
              positive and hygienic environment for your customers.
            </p>
            <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
              If you have specific cleaning needs or would like to discuss how
              our services can benefit your gym, yoga studio, or bowling alley,
              please feel free to reach out to us. We would be more than happy
              to assist you and provide a free walk-through of your space to
              determine the best cleaning solutions for your establishment.
            </p>
          </article>
