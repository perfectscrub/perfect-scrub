  ...
  return (
    <>
      <Head>
        ...
        <meta
          content="We clean day-care facilities and pre-schools. We leave the facility neat and ready for use"
          name="description"
        />
      </Head>
      <main role="main">
        {/* Start of 'Facilities' Landing */}
        <LandingSection bgImg={"day-care-bg-image"} type={"facilities"} title={"Daycares & Preschools"} />
