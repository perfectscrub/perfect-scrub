...
const Contact = () => {
  return (
    <>
      <Head>
        <title>Perfect Scrub Cleaning Services - Contact Us</title>
        <meta
          content="Contact us | we are a cleaning service for the Greater Toronto Area. For more information, Please contact us"
          name="description"
        />
      </Head>
      <main role="main">
