  ...
  return (
    <main role="main">
      <section class="landing-section relative overflow-hidden flex flex-col lg:flex-row lg:justify-around pt-28 lg:pt-44 lg:pl-10 bg-gradient-to-br from-blue-600 to-green-400">
        ...
        {/* Contact Image */}
        <div class="get_in_touch-image w-full lg:w-1/2 place-self-end"></div>
      </section>
      {/* Contact Form */}
      <section class="relative contact bg-gradient-bl from-gray-50 to-blue-200 px-4 py-12 lg:pt-24 lg:pb-32">
        {/* Form */}
        <div class="text-gray-700 bg-transparent p-4 pb-8 mx-auto max-w-2xl">
          <h2 class="font-sans text-4xl font-semibold mt-6">
            Have a question for us?
          </h2>
          <p class="text-gray-700 font-sans text-xl font-semibold mt-4 lg:w-1/2 italic">
            or do you want a{" "}
            <Link class="text-green-500 underline" href="quote">
              free quote
            </Link>
            ?
          </p>
          ...
          >
            ...
            <div class="mt-4">
              <label class="font-semibold" for="choose-service">
            ...
            <button
              type="submit"
              id="submit-button"
              class="w-full md:w-1/2 uppercase font-semibold text-center px-5 py-3 shadow-md my-4 lg:mb-0 bg-green-600 border border-green-500 text-white hover:bg-green-400 hover:border-green-400 focus:ring-4 focus:ring-green-300"
            >
              Send Message
            </button>
          </form>
      ...
      <section
        id="contact-us"
        class="flex justify-center items-center py-16 bg-gradient-to-br from-blue-100 via-blue-300 to-green-300 text-xl"
      >
        {/* Contact Info */}
        <div class="w-full lg:w-3/4 rounded-md overflow-hidden lg:shadow-2xl z-20">
          <div class="bg-gray-200 w-full bg-white bg-opacity-30 h-full py-12">
            <div class="flex flex-col items-center justify-center">
              <h2 class="font-medium mb-5 text-center text-gray-700">
                Get in Touch
              </h2>
              <div>
                <div class="flex items-center mb-10">
                  <div class="p-2 rounded-full mr-6 bg-green-200">
                    <svg
