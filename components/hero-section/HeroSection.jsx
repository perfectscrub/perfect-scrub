      ...
      <div className="hero-1">
        <Link href="/commercial-cleaning">
          <div className="group h-full w-full flex items-center justify-center md:justify-start">
            <h2 className="text-2xl md:text-4xl lg:text-5xl leading-none text-white text-center font-bold md:ml-8 lg:ml-16 px-6 py-8 group-hover:bg-green-400 group-focus:bg-green-400 rounded">
              Commercial <br />
              Cleaning
            </h2>
          </div>
