...
export const metadata = {
  ...
  description:
    "We clean schools and high institutions of learning like universities, colleges. Call us today and get a quote",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            ...
            excellent learning environment, but they also present challenges in
            terms of maintaining cleanliness and sanitation. The close proximity
            and frequent interaction among individuals create opportunities for
            the spread of germs, making cross-contamination a significant
            concern.
          </p>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            At Perfect Scrub Cleaning, we understand the importance of creating
            a safe and healthy environment for academic staff and students. Our
            dedicated school cleaning services prioritize the well-being of
            everyone in the educational setting. We take proactive measures to
            ensure that your team is kept safe by performing multiple
            disinfecting services on a daily basis.
          </p>
          <Image
            width={500}
            height={500}
          ...
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            ...
            mind knowing that your academic space is being meticulously cleaned
            and disinfected. Contact us today to ensure that everyone, from
            staff to students, remains healthy and can thrive in a clean and
