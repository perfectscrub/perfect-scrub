...
export const metadata = {
  ...
  description:
    "Your customers expect the best when they come to your store. We can keep your store clean and you can keep the customers coming in",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            ...
            service experience. Our professional cleaning services allow you to
            focus on the business of selling while we handle the clean-up
            process.
          </p>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            Retail stores are particularly sensitive environments with numerous
            touchpoints that require regular disinfection. At Perfect Scrub
            Cleaning, we know how important it is to maintain a safe and healthy
            space for both your staff and customers. Our service ensures a
            thorough cleaning of all surfaces and implements regular
          ...
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            ...
            services tailored specifically for retail stores, don't hesitate to
            contact us today. We are dedicated to providing you with a clean and
            welcoming environment that leaves a positive impression on your
            customers.
          </p>
        </article>
