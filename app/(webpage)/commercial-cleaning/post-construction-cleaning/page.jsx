...
export const metadata = {
  title: " Post-construction cleaning of Facilities",
  description:
    "We can clean out your newly completed project, home or business. We leave you with a clean environment to start your new stage",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            ...
            project! At Perfect Scrub, we comprehend the importance of providing
            a clean and spotless environment for your clients to enjoy. We are
            here to assist you with the clean-up process and ensure that your
            new construction looks impeccable, giving your clients the homely
            feeling they desire.
          </p>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            Our team is experienced in post-construction cleaning and knows the
            unique challenges involved in removing debris and thoroughly
            cleaning the space. We will meticulously clean all areas, including
            removing construction materials, dusting, and sanitizing surfaces to
            create a pristine and welcoming atmosphere.
          </p>
          <Image
            width={500}
            height={500}
          ...
          />
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            Our comprehensive cleaning services include washing and cleaning all
            washrooms, ensuring they are fresh and hygienic. We also pay close
            attention to detail when it comes to cleaning windows, doors,
            cabinets, and furniture, leaving no trace of dust or dirt behind.
            Our goal is to provide a thorough and detailed cleaning service that
          ...
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-16 leading-relaxed text-gray-600">
            ...
            customize our cleaning approach to suit your specific needs. Whether
            you require additional services or have specific cleaning
