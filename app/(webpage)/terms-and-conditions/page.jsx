...
export const metadata = {
  description: "Terms and conditions for the use of our services",
};
        ...
        <article className="max-w-screen-xl lg:mx-8">
          ...
          <div className="max-w-prose mx-6 lg:mx-auto text-gray-600 mt-16 lg:mt-24">
            ...
            <p className="mb-4">
              ...
              and operated by Perfect Scrub Cleaning Services (“COMPANY” “we” or
              “us”). By using the Site, you agree to be bound by these Terms of
              Service and to use the Site in accordance with these Terms of
              Service, our Privacy Policy and any additional terms and
              conditions that may apply to specific sections of the Site or to
              products and services available through the Site or from COMPANY.
