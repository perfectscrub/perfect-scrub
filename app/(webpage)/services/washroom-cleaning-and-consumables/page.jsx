...
export const metadata = {
  ...
  description:
    "With us you can be sure that your office or business washroom will be cleaned an well stocked with the needed supplies. Call and get a quote",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            ...
            of paper products, dispensing systems, soap, and hand wash products
