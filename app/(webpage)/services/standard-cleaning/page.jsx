...
export const metadata = {
  ...
  description:
    "Our standard cleaning service is all you need to get that office space looking nice and tidy. Get a free quote today",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            ...
            thorough cleaning of all visible surfaces. You have the flexibility
            to choose the frequency of our cleaning service, whether it's on a
