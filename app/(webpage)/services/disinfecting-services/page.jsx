...
export const metadata = {
  ...
  description:
    "We can disinfect your business, office, warehouse of germs, bacteria, viruses. Call us to get a free quote",
};
      ...
      <section className="px-4 lg:px-16 pt-24 pb-0 lg:pt-40 lg:pb-10 flex gap-14">
        <article>
          <p className="text-xl lg:text-2xl max-w-prose lg:pr-16 pb-10 leading-relaxed text-gray-600">
            To ensure effective disinfection, we prioritize thorough cleaning to
            eliminate dust and dirt from your facility beforehand. Our
