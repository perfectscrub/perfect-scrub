...
export const schema = z.object({
    ...
    email: z.string().min(1, { message: "Enter a email" }),
    ...
    businessPostcode: z.string().regex(new RegExp(/^[ABCEGHJ-NPRSTVXY]\d[ABCEGHJ-NPRSTV-Z][ -]?\d[ABCEGHJ-NPRSTV-Z]\d$/i), { message: "Enter a valid business postal code" }),
    ...
    emergencyContacts: z.array(
      z.object({
        name: z.string().min(1, { message: "Enter the name of your emergency contact" }),
        email: z.string().email(1, { message: "Enter a valid email of emergency contact" }),
